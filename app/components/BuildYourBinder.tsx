...
const BuildYourBinder: React.FC = () => {
  return (
    <section className="border-y border-border bg-gradient-to-br from-accent to-primary-hover">
      <div className="mx-auto grid w-full max-w-content gap-10 px-gutter py-16 sm:py-20 lg:grid-cols-2 lg:items-center">
        ...
        <ul className="grid gap-4">
          {FEATURES.map(feature => (
            <li
              key={feature.title}
              className="rounded-panel bg-white/10 p-5 ring-1 ring-white/20 backdrop-blur"
            >
