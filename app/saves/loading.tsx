// Saves loading state: header plus a pulsing card grid matching the loaded
// layout (rail space included on desktop) so the swap to real cards is
// seamless.
const SavesLoading: React.FC = () => (
  <main
