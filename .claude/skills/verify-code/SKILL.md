...
<rule id="check-not-fix">You verify and report; you do NOT edit code (that is work-task's job in Running). File each problem as a change request and route the task to Running.</rule>
